...
def train(model="sch", epochs=80, device=th.device("cpu"), train_file='', test_file='',save='./'):
    ...
    model.to(device)
    initNetParams(model)
    model.load_state_dict(th.load('saved_model/model_C_100', map_location=th.device('cpu')))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_file", help="dataset to train", default="./DATA/C_NMR/C-NMR_train.csv")
    parser.add_argument("--test_file", help="dataset to test", default="./DATA/C_NMR/C-NMR_valid.csv")
