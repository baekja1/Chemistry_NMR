...
if __name__ == "__main__":
    ...
    parser.add_argument("-M",
                        ...
                        default="sch_qm")
    parser.add_argument("--saved_model", '-S',help="number of epochs", default="./model_5020")
    parser.add_argument("--eval_dataset",'-E', help="dataset to train", default="./DATA/C_NMR/C-NMR_valid.csv")
